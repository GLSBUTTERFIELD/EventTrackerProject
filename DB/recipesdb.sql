...
START TRANSACTION;
USE `recipesdb`;
INSERT INTO `recipe` (`id`, `food_type_id`, `title`, `description`, `servings`, `prep_time_minutes`, `cook_time_minutes`, `total_time_minutes`, `directions`, `source`, `website_url`, `image_url`, `create_date`, `last_update`, `enabled`) VALUES (1, 2, 'Korean Beef Bowls', 'Ground beef, veggies, and white rice with a flavorful Korean sauce.', '3-4', 10, 15, 25, 'In a small bowl, whisk together brown sugar, soy sauce, sesame oil, red pepper flakes, and ginger.; Heat vegetable oil in a large skillet over medium-high heat. Add garlic and cook, stirring constantly, until fragrant, about 1 minute. Add ground beef and cook until browned, about 3-5 minutes. Crumble the beef as it cooks, then drain the excess fat.; Stir in soy sauce mixture and green onions until combined. Simmer until heated through, about 2 minutes.; Serve immediately with rice, vegetables, and whatever toppings you have on hand (fried egg, sesame seeds, furikake, kewpie, etc.).', 'Damn Delicious', 'https://damndelicious.net/2013/07/07/korean-beef-bowl/', 'https://s23209.pcdn.co/wp-content/uploads/2013/07/Korean-Beef-Bowl_111-760x1140.jpg.webp', '2025-01-01 12:00', '2025-01-01 12:00', 1);
INSERT INTO `recipe` (`id`, `food_type_id`, `title`, `description`, `servings`, `prep_time_minutes`, `cook_time_minutes`, `total_time_minutes`, `directions`, `source`, `website_url`, `image_url`, `create_date`, `last_update`, `enabled`) VALUES (2, 2, 'Green Onion Chili Oil Noodles', 'Vinegary and oniony with a little bit of heat and lots of sesame seeds. Enjoy with or without veggies or a protein.', '2', 5, 5, 10, 'Cook the noodles per package directions.; Add the spices, sesame seeds, and sugar together in a large pan.; Heat the oil in a small pan over medium high heat, turn it off and immediately add green onions and garlic for a few seconds.; Immediately pour over spices, sugar, and sesame seeds and mix together with soy sauce and red vinegar.; Add in cooked noodles and mix well. Enjoy!', 'thespicyjuju', 'https://www.instagram.com/thespicyjuju/reel/CtPYcI6OueO/', 'https://i.imgur.com/sGJdUAc.png', '2025-01-01 12:00', '2025-01-01 12:00', 1);
INSERT INTO `recipe` (`id`, `food_type_id`, `title`, `description`, `servings`, `prep_time_minutes`, `cook_time_minutes`, `total_time_minutes`, `directions`, `source`, `website_url`, `image_url`, `create_date`, `last_update`, `enabled`) VALUES (3, 7, 'Spring Rolls', 'Refreshing and packed with flavor, these spring rolls are a fun way to get your vegetables in.', '10-12', 25, 5, 30, 'Prep your fillings, cutting the vegetables into slices the desired length of your spring rolls. Season the tofu and airfry until cooked through.; Make the peanut dipping sauce: combine the sweet chili sauce, peanut butter, soy sauce, and hoisin sauce to a food processor or blender and pulse until smooth.; Cook the rice noodles per package directions.; In a large bowl or pot of warm water, gently soak one rice paper wrapper at a time for 10-15 seconds (the rice paper will continue to soften after being removed from the water so don\'t soak too long or your roll will tear).; Lay your rice paper out and assemble your spring roll in the 1/3 closest to you, leaving space on each side. Start rolling from the bottom and roll the sides in, like you\'re rolling a burrito.; Top with sesame seeds and serve with peanut sauce or other desired sauce.', 'Tastes Better from Scratch', 'https://tastesbetterfromscratch.com/fresh-spring-rolls/', 'https://tastesbetterfromscratch.com/wp-content/uploads/2018/03/Spring-Rolls-14.jpg', '2025-01-01 12:00', '2025-01-01 12:00', 1);
...
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (31, 'shrimp', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (32, 'red potatoes', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (33, 'Old Bay', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (34, 'butter', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (35, 'white onion', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (36, 'lemon', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (37, 'andouille sausage', NULL, NULL);
INSERT INTO `ingredient` (`id`, `name`, `description`, `image_url`) VALUES (38, 'ears of corn', NULL, NULL);
